...
<jsp:include page="../layout/header_seller.jsp"></jsp:include>
	<section>
	<form:form id="post-form" method="post" enctype="multipart/form-data" action="/seller/productcreate">
		<div>
		...
		<div id="orderMemberInfo">
			...
			<ul class="orderMemberInfoArea">
				...
				<li><input id="prdTitleImg" type="file" name="prdTitleImgfile" /></li>
			</ul>
			<ul class="orderMemberInfoArea">
				<li><label for="prdContentImg">상세 이미지</label></li>
				<li><input id="prdContentImg" type="file" name="prdContentImgfile" /></li>
			</ul>
			<ul class="orderMemberInfoArea">
			...
			<ul class="orderMemberInfoArea">
				...
				<li><textarea id="prd_content" name="prdContent" style="height: 80px;" placeholder="간단한 설명을 입력해주세요" >${productVO.prdContent}</textarea></li>
			</ul>
			<ul class="orderMemberInfoArea">
			...
			<ul class="orderMemberInfoArea">
				<li></li>
				<li><input type="button" class="btn_fill_s" id="inputBtn" value="저장" onclick="createChoice()"/></li>
			</ul>
		</div>
	</form:form>
	</section>
