...
<body>
	<div class="container">
		<div class="saleState">
		    <form:form modelAttribute="chartSearchVO" method="post" enctype="multipart/form-data" action="/sellerChart/sellerChart10">
		        <div>
