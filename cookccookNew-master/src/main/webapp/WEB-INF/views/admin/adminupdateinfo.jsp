...
<style type="text/css">
	...
	/* 입력란(input) 스타일 */
	input.form-control {
		width: 100%; /* 입력란의 너비를 조절합니다. */
		height: 100%;
		padding: 10px;
		border: 1px solid #CCC;
		box-sizing: border-box; /* 입력란의 너비에 패딩과 경계선을 포함합니다. */
	}
	
	/* 버튼 스타일 */
	button.btn.btn-default {
		width: 100%; /* 버튼의 너비를 조절합니다. */
		padding: 10px;
		border: 1px solid #CCC;
		box-sizing: border-box; /* 버튼의 너비에 패딩과 경계선을 포함합니다. */
		cursor: pointer;
	}
	
	/* 아이콘 스타일 (FontAwesome 아이콘에 대한 스타일 설정) */
	button i.fa {
		font-size: 16px; /* 아이콘 크기를 조절합니다. */
	}
	#btn-regist {
		cursor: pointer;
		width: 80px;
