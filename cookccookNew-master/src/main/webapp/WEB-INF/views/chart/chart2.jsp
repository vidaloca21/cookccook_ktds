...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawCharts() {
            ...
            // 파이 차트 옵션
            var pieOptions = {
                title: '연별 상품 매출 순위 (파이차트)',
                is3D: true,
                pieSliceText: 'value',
                slices: { 0: { color: '#778899' }, 1: { color: 'red' }, 2: { color: '#faebd7' }
                }
            };

            // 막대 차트 옵션
            var barOptions = {
                title: '연별 상품 매출 순위 (막대차트)',
...
<body>
    <form:form modelAttribute="chartSearchVO" method="get" enctype="multipart/form-data" action="/chart/chart2">
        <div>
