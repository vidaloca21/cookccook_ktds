        ...
        function drawCharts() {
            var data = google.visualization.arrayToDataTable([
                ...
                <c:forEach items="${chartList}" var="chart">
                    ['${chart.prdName}', ${chart.totalPrice}, ${chart.totalQuantity}],
                </c:forEach>
            ]);

            // 파이 차트 옵션
            var pieOptions = {
                title: '월별 상품 매출 순위 (파이차트)',
                is3D: true,
                pieSliceText: 'value',
                slices: { 0: { color: 'skyblue' }, 1: { color: '#a57e7e' }, 2: { color: '#dda0dd' }
                }
            };

            // 막대 차트 옵션
            var barOptions = {
                title: '월별 상품 매출 순위 (막대차트)',
...
<body>
	<form:form modelAttribute="chartSearchVO" method="get" enctype="multipart/form-data" action="/chart/chart1">
	    <div>
